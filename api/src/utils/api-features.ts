...
/**
 * @description Bazı api özellikleri için kullanılacak class Örnek olarak filtrelemek ya da sıralamak
 * */
export class APIFeatures<T extends Document> {
	constructor(public query: Query<T | T[] | null, T>, public queryString: Record<string, any>) {}
